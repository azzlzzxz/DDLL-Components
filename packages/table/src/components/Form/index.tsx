...
import type { ActionType, FXTableProps } from '../../typing';
...
type BaseFormProps<T, U> = {
  ...
  columns: FXTableProps<T, U, any>['columns'];
  dateFormatter: FXTableProps<T, U, any>['dateFormatter'];
  formRef: FXTableProps<T, U, any>['formRef'];
  type: FXTableProps<T, U, any>['type'];
  cardBordered: FXTableProps<T, U, any>['cardBordered'];
  form: FXTableProps<T, U, any>['form'];
  search: FXTableProps<T, U, any>['search'];
  manualRequest: FXTableProps<T, U, any>['manualRequest'];
};
