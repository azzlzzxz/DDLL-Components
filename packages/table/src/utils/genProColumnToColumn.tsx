...
import type { FXColumnGroupType, FXColumns } from '../typing';
import {
  columnRender,
  defaultOnFilter,
  renderColumnsTitle,
...
export function genProColumnToColumn<T>(
  ...
  parents?: FXColumnGroupType<T, any>,
  ...
  return columns
    ?.map((columnProps, columnsIndex) => {
      const {
        ...
        onFilter,
        filters = [],
      } = columnProps as FXColumnGroupType<T, any>;
      ...
      const tempColumns = {
        ...
        children: (columnProps as FXColumnGroupType<T, any>).children
          ? genProColumnToColumn(
              {
                ...params,
                columns: (columnProps as FXColumnGroupType<T, any>)?.children,
              },
              { ...columnProps, key: columnKey } as FXColumnGroupType<T, any>,
            )
          : undefined,
